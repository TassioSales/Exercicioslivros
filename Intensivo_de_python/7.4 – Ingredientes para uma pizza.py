...
while True:
    ...
    if ingrediente == 'exit':
        ...
        cont = cont - 1
        print('Muito obrigado, Porem voce ja atingiu o limite maximo de ingredientes das sua '
              'pizza, digite Exit para encerrar o programa, que loga estaremos levando sua pizza para o forno\n')
        break
