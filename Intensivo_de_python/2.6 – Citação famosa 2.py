...
citacao = f"""Para {pessoa} a imaginação é uma arma poderosa para 
resolver problemas, sendo mais importante ainda do que o 
conhecimento. A imaginação é mais importante que o conhecimento. 
