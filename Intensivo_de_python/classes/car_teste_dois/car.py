class Car():  # Uma tentativa simples de representar um carro.
    ...
    def update_odometer(self, mileage):
        """Define o valor de leitura do hodômetro com o valor especificado Rejeita alteração se for tentativa de
        definir um valor menor para o hodômetro """
...
class ElectricCar(Car):
    ...
    def __init__(self, make, model, year):
        """Inicializa os atributos da classe-pai.Em seguida, inicializa os atributos específicos de um carro
        elétrico. """
