...
let lugaresMundo =['Austrália','França','Bora Bora','Florença','Itália','Tóquio','Japão','Cusco','Peru']

console.log(`Fora de ordem : ${lugaresMundo}`)
console.log(`Em oredem : ${lugaresMundo.sort()}`)

lugaresMundoOrganisation = lugaresMundo.sort()

console.log(`De traz pra frente : ${lugaresMundoOrganisation.reverse()}`)